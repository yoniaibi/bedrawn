...
function getRealId(idProp: string): string {
  ...
  // pathname: /draw/<id>/postal → segments[1] = id
      ...
      <div className="form-wrap" style={{ background: '#0D0B14', padding: '24px 16px 48px' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
            <div>
              <p style={{ margin: 0, fontSize: 22, fontWeight: 900, fontStyle: 'italic', color: '#111', letterSpacing: -0.5 }}>
                bedrawn
              </p>
              <p style={{ margin: '2px 0 0', fontSize: 9, color: '#666', letterSpacing: 2, textTransform: 'uppercase', fontFamily: 'sans-serif' }}>
                bedrawn.app
              </p>
            </div>
            <div style={{ textAlign: 'right' }}>
              <p style={{ margin: 0, fontSize: 13, fontWeight: 700, letterSpacing: 1.5, color: '#111', fontFamily: 'sans-serif', textTransform: 'uppercase' }}>
                Free Postal Entry
              </p>
              <p style={{ margin: '2px 0 0', fontSize: 9, color: '#888', fontFamily: 'sans-serif' }}>
          ...
          <div style={{ background: '#F8F8F8', border: '1px solid #ddd', borderRadius: 4, padding: '10px 14px', marginBottom: 14 }}>
            <p style={{ margin: '0 0 8px', fontSize: 10, fontFamily: 'sans-serif', color: '#666', letterSpacing: 1, textTransform: 'uppercase' }}>
              Draw Details
            </p>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11, fontFamily: 'sans-serif' }}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ fontFamily: 'monospace', fontSize: 10, color: '#111', letterSpacing: 0.5, paddingBottom: 4 }}>
                    {drawId}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style={{ fontWeight: 700, color: '#c00' }}>
                    ...
                    <span style={{ fontWeight: 400, color: '#666', fontSize: 10, marginLeft: 4 }}>
          ...
          {[
            { label: 'Full name', lines: 1 },
            { label: 'bedrawn account email or username', lines: 1 },
          ].map(field => (
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            {['Address line 1', 'Address line 2 (optional)', 'Town / City', 'County (optional)', 'Postcode'].map(line => (
              <div key={line} style={{ display: 'flex', alignItems: 'flex-end', gap: 8, marginBottom: 6 }}>
                <span style={{ fontSize: 9, color: '#888', fontFamily: 'sans-serif', whiteSpace: 'nowrap', width: 100, flexShrink: 0, paddingBottom: 2 }}>
                  {line}
                </span>
          ...
          <div style={{ border: '2px dashed #999', borderRadius: 4, padding: '10px 14px' }}>
            <p style={{ margin: '0 0 4px', fontSize: 9, fontFamily: 'sans-serif', color: '#666', textTransform: 'uppercase', letterSpacing: 1 }}>
              Post this form to
            </p>
            <p style={{ margin: 0, fontSize: 12, fontFamily: 'sans-serif', fontWeight: 700, color: '#111', lineHeight: 1.6 }}>
              {POSTAL_ADDRESS}
            </p>
